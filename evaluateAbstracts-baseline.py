...
generated_abstracts_df = pd.read_csv(constants.GENERATED_ABSTRACTS_BASELINE_FILE)
...
print("writing to file", constants.EVALUATED_ABSTRACTS_BASELINE_FILE)
df.to_csv(constants.EVALUATED_ABSTRACTS_BASELINE_FILE, index=False)
